            ...
            <div className="bg-slate-950/50 border border-slate-800 rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="# Netscape HTTP Cookie File&#10;# Paste your exported YouTube cookies here (Netscape format)&#10;.youtube.com    TRUE    /       TRUE    1900000000      COOKIE_NAME     value"
                  rows={12}
                  spellCheck={false}
                  wrap="off"
                  className="w-full bg-slate-950 border border-slate-700 rounded-lg p-2.5 text-slate-200 focus:outline-none focus:border-orange-500 font-mono text-xs transition-colors resize-y overflow-x-auto whitespace-pre"
                />
                <p className="text-[10px] text-slate-500 mt-1.5">
                  Export cookies from your browser using the <span className="text-orange-400 font-medium">Cookie-Editor</span> extension → Export as Netscape format → paste here. Saves instantly when you click Save Settings.
                </p>
              </div>
            </div>
          </section>
