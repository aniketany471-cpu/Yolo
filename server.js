...
async function getAIResponse(prompt, config, chatId, userId, isNSFWActive = false, forceDeep = false, senderUsername = null, requestId = "chat", opts = {}) {
  ...
  if (imageGenerationIntent) {
    ...
    const hasSportsKeyword = /\b(cricket|ipl|t20|odi|test match|test series|one day|twenty20|drs|super over|powerplay|football|soccer|nba|nfl|nhl|nba finals|nfl draft|ufc|mma|bellator|pfl|f1|formula 1|formula one|grand prix|gp|race|circuit|qualifying|pit stop|fastest lap|pole position|match|score|scores|result|results|scorecard|highlights|live score|wicket|wickets|run rate|over|boundary|six|four|hat trick|goal|goals|penalty|red card|yellow card|offside|var|assist|own goal|lineup|playing 11|squad|xi|injury|injured|fit|injury update|transfer|transfer news|transfer window|signed|signed for|sold|bought|released|ranking|leaderboard|podium|points table|standings|table|series|tournament|champion|champions|trophy|cup final|title|title race|league|premier league|epl|la liga|bundesliga|serie a|ligue 1|eredivisie|mls|a-league|copa america|copa|euros|euro 2024|euro 2025|euro 2026|world cup|wc|asia cup|psl|bbl|cpl|npl|sa20|illt20|wpl|wbbl|kabaddi|pkl|hockey|field hockey|badminton|bwf|thomas cup|uber cup|sudirman cup|tennis|wimbledon|us open|french open|roland garros|australian open|atp|wta|grand slam|davis cup|boxing|wbc|wba|ibf|wbo|fight night|wrestling|wwe|aew|raw|smackdown|olympics|commonwealth games|asian games|paralympics|chess|fide|esports|valorant|csgo|dota|lol|worlds|major|swimming|athletics|100m|marathon|f2|indycar|motogp|nascar|superbike|rally|wrc|snooker|darts|cycling|tour de france|vuelta|giro|rugby|six nations|super rugby|nrl|afl|baseball|mlb|world series|nba draft)\b/i.test(msgLower);

    const hasWeatherKeyword = /\b(weather|temperature|temp|°c|°f|celsius|fahrenheit|forecast|humidity|rain|raining|rainfall|rainy|sunny|sunshine|cloudy|overcast|storm|thunderstorm|lightning|typhoon|cyclone|hurricane|tornado|heatwave|heat wave|cold wave|cold snap|aqi|air quality|air pollution|pm2\.?5|pm10|wind|wind speed|gale|gust|uv index|uv|feels like|dew point|snowfall|snow|blizzard|fog|foggy|smog|monsoon|drizzle|mist|hail|frost|ice|black ice|flood|flooding|drought)\b/i.test(msgLower);

    const hasNewsKeyword = /\b(news|breaking|breaking news|latest news|just in|top news|headline|headlines|update|updates|today news|current news|live news|live update|report|reportedly|sources say|official|officially|announcement|announced|announces|confirmed|confirms|election|election result|election 2024|election 2025|election 2026|vote|voting|ballot|exit poll|poll|verdict|judgment|acquitted|convicted|sentenced|arrest|arrested|detained|bail|jailbreak|attack|terror|terrorist|explosion|blast|bombing|shooting|gunfire|crash|accident|plane crash|train crash|car crash|earthquake|flood|disaster|natural disaster|eruption|volcano|landslide|tsunami|launch|launched|unveil|unveiled|debut|release|released|pm|prime minister|president|vice president|minister|cabinet|parliament|congress|senate|governor|mayor|government|policy|bill|act|law|legislation|budget|economy|gdp|inflation|deflation|rate cut|rate hike|rbi|sebi|fed|federal reserve|ecb|imf|world bank|modi|trump|biden|harris|putin|xi|zelensky|zelenskyy|nato|un|united nations|g20|g7|g8|brics|summit|meet|bilateral|treaty|agreement|deal|accord|ceasefire|peace talks|war|conflict|invasion|offensive|airstrike|missile|drone|military|troops|soldier|sanctions|embargo|tariff|trade war|strike|protest|riot|rally|march|demonstration|coup|crisis|emergency|shutdown|lockdown|curfew|merger|acquisition|takeover|buyout|ipo|listing|shares|stock market|sensex|nifty|dow jones|nasdaq|s&p|crypto|bitcoin|btc|eth|ethereum|price|prices)\b/i.test(msgLower);
